...
describe '/recipes', type: :request do
  ...
  let(:recipe) do
    user.recipes.create(name: 'tequila mojito', preparation_time: '10', cooking_time: 10,
                        description: 'The  combination of good aged tequila, mint, and sugary syrup', public: true)
  end
  ...
  describe 'POST /create' do
    ...
    it 'should create a new recipe' do
      expect do
        post recipes_path,
             params: { recipe: { name: 'Tequila Mojito', preparation_time: '10', cooking_time: 10,
